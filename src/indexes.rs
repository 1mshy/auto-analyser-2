...
pub static SP500_SYMBOLS: &[&str] = &[
    "A", "AAPL", "ABBV", "ABNB", "ABT", "ACGL", "ACN", "ADBE", "ADI", "ADM", "ADP", "ADSK", "AEE",
    "AEP", "AES", "AFL", "AIG", "AIZ", "AJG", "AKAM", "ALB", "ALGN", "ALL", "ALLE", "AMAT", "AMCR",
    "AMD", "AME", "AMGN", "AMP", "AMT", "AMZN", "ANET", "ANSS", "AON", "AOS", "APA", "APD", "APH",
    "APTV", "ARE", "ATO", "AVB", "AVGO", "AVY", "AWK", "AXON", "AXP", "AZO", "BA", "BAC", "BALL",
    "BAX", "BBWI", "BBY", "BDX", "BEN", "BF.B", "BG", "BIIB", "BIO", "BK", "BKNG", "BKR", "BLDR",
    "BLK", "BMY", "BR", "BRK.B", "BRO", "BSX", "BWA", "BX", "BXP", "C", "CAG", "CAH", "CARR",
    "CAT", "CB", "CBOE", "CBRE", "CCI", "CCL", "CDNS", "CDW", "CE", "CEG", "CF", "CFG", "CHD",
    "CHRW", "CHTR", "CI", "CINF", "CL", "CLX", "CMCSA", "CME", "CMG", "CMI", "CMS", "CNC", "CNP",
    "COF", "COO", "COP", "COR", "COST", "CPAY", "CPB", "CPRT", "CPT", "CRL", "CRM", "CRWD", "CSCO",
    ...
    "FDS", "FDX", "FE", "FFIV", "FI", "FICO", "FIS", "FITB", "FLT", "FMC", "FOX", "FOXA", "FRT",
    "FSLR", "FTNT", "FTV", "GD", "GDDY", "GE", "GEHC", "GEN", "GEV", "GILD", "GIS", "GL", "GLW",
    ...
    "SNPS", "SO", "SOLV", "SPG", "SPGI", "SRE", "STE", "STLD", "STT", "STX", "STZ", "SWK", "SWKS",
    "SYF", "SYK", "SYY", "T", "TAP", "TDG", "TDY", "TECH", "TEL", "TER", "TFC", "TFX", "TGT",
    "TJX", "TMO", "TMUS", "TPR", "TRGP", "TRMB", "TROW", "TRV", "TSCO", "TSLA", "TSN", "TT",
    "TTWO", "TXN", "TXT", "TYL", "UAL", "UBER", "UDR", "UHS", "ULTA", "UNH", "UNP", "UPS", "URI",
    "USB", "V", "VFC", "VICI", "VLO", "VLTO", "VMC", "VRSK", "VRSN", "VRTX", "VST", "VTR", "VTRS",
    "VZ", "WAB", "WAT", "WBA", "WBD", "WDC", "WEC", "WELL", "WFC", "WM", "WMB", "WMT", "WRB",
...
pub static NASDAQ100_SYMBOLS: &[&str] = &[
    ...
    "ARM", "ASML", "AVGO", "AZN", "BIIB", "BKNG", "BKR", "CCEP", "CDNS", "CDW", "CEG", "CHTR",
    "CMCSA", "COST", "CPRT", "CRWD", "CSCO", "CSGP", "CSX", "CTAS", "CTSH", "DASH", "DDOG", "DLTR",
    "DXCM", "EA", "EXC", "FANG", "FAST", "FTNT", "GEHC", "GFS", "GILD", "GOOG", "GOOGL", "HON",
    "IDXX", "ILMN", "INTC", "INTU", "ISRG", "KDP", "KHC", "KLAC", "LIN", "LRCX", "LULU", "MAR",
    "MCHP", "MDB", "MDLZ", "MELI", "META", "MNST", "MRNA", "MRVL", "MSFT", "MU", "NFLX", "NVDA",
    "NXPI", "ODFL", "ON", "ORLY", "PANW", "PAYX", "PCAR", "PDD", "PEP", "PYPL", "QCOM", "REGN",
    "ROP", "ROST", "SBUX", "SMCI", "SNPS", "SPLK", "TEAM", "TMUS", "TSLA", "TTD", "TTWO", "TXN",
...
pub static DOW30_SYMBOLS: &[&str] = &[
    "AAPL", "AMGN", "AMZN", "AXP", "BA", "CAT", "CRM", "CSCO", "CVX", "DIS", "DOW", "GS", "HD",
    "HON", "IBM", "INTC", "JNJ", "JPM", "KO", "MCD", "MMM", "MRK", "MSFT", "NKE", "NVDA", "PG",
    "TRV", "UNH", "V", "WMT",
];
...
pub static RUSSELL2000_TOP_SYMBOLS: &[&str] = &[
    "ACIW", "AGCO", "AIT", "ALKS", "AMED", "AMKR", "AMSF", "APPF", "ASGN", "AZEK", "BCO", "BDC",
    "BFAM", "BGCP", "BILL", "BOOT", "BPMC", "BRBR", "CAKE", "CALX", "CARG", "CATY", "CBSH", "CCOI",
    "CHE", "CHH", "CHRD", "CIEN", "CLVT", "CNK", "CNMD", "CNXC", "COHR", "COKE", "COLB", "COOP",
    "CORT", "CRVL", "CSGP", "CSWI", "CWK", "DAN", "DCI", "DLX", "DORM", "ENSG", "ESNT", "EVR",
    "EXPO", "FAF", "FCFS", "FIX", "FHI", "FIVE", "FLO", "FROG", "FSS", "GEF", "GKOS", "GMS",
    "GNTX", "GOLF", "GSHD", "GTY", "HALO", "HASI", "HELE", "HLI", "HLNE", "HOMB", "HQY", "HRI",
    "HTLD", "HUBG", "HZO", "IBOC", "IBTX", "ICUI", "IDCC", "IPAR", "ITGR", "JBT", "JJSF", "KAMN",
    "KBR", "KLIC", "KMPR", "KNF", "KREF", "KRG", "LANC", "LAUR", "LAWS", "LCII", "LFUS", "LGIH",
    "LNTH", "LSTR", "MASI", "MATX", "MAXR", "MCRI", "MEDP", "MGEE", "MGRC", "MIDD", "MLI", "MMSI",
    "MOG.A", "MORN", "MRCY", "MSTR", "MTDR", "MTH", "MTRN", "MUSA", "NEOG", "NFG", "NMIH", "NOVT",
    "NWE", "NXGN", "OGS", "OLED", "OMCL", "OSK", "OTTR", "PATK", "PCRX", "PDCE", "PEN", "PGNY",
    "PINC", "PIPR", "PLMR", "PLXS", "PLUS", "POWI", "PPBI", "PRFT", "PSN", "PSTG", "PTGX", "PVH",
    "QLYS", "RAMP", "RCII", "REXR", "RH", "RHP", "RLI", "RMBS", "ROCK", "RPD", "RUSHA", "SABR",
    "SAFM", "SANM", "SATS", "SBCF", "SCI", "SEIC", "SGRY", "SHAK", "SITE", "SKY", "SLGN", "SM",
    "SMTC", "SNDR", "SPSC", "SPXC", "SSD", "STAA", "STEP", "STRA", "STRL", "SUM", "SWX", "TBBK",
    "TCBI", "TENB", "THRM", "THS", "TKR", "TNDM", "TREX", "TRNO", "TRN", "TTEC", "TTEK", "TXRH",
    "UDMY", "UFI", "UMBF", "UNFI", "URBN", "VCEL", "VNT", "VSCO",
];
